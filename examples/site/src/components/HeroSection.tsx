    ...
    <section className='min-h-screen flex items-center justify-center px-4 py-20 relative'>
      <div className='max-w-4xl mx-auto text-center space-y-8'>
        <h1 className='text-4xl lg:text-6xl font-bold'>
          <span className={`title-gradient bg-clip-text text-transparent transition-all duration-500`}>
            Offline Detector
          </span>
        </h1>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center items-center pt-8'>
          <button className='inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg shadow-lg transition-colors duration-300' onClick={() => window.open('https://github.com/hiteshshetty-dev/offline-detector', '_blank')}>
